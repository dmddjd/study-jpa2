...
import jpa2.domain.*;
import jpa2.service.OrderService;
import jpa2.domain.item.Book;
import jpa2.exception.NotEnoughStockException;
...
class OrderServiceTest {
    ...
    void 상품주문() throws Exception {
        ...
        assertEquals(10000 * orderCount, getOrder.getTotalPrice(), "주문 가격은 상품가격 * 수량");
    ...
    void 주문취소() throws Exception {
        ...
        assertEquals(10, item.getStockQuantity(), "주문이 취소된 상품은 수량이 다시 증가해야 함");
    }
